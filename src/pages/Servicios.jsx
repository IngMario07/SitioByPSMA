                ...
                <div className="bg-white py-16 px-6">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <motion.p
                            ...
                            transition={{ duration: 1, delay: 0.5 }}
                        >
                            Atendemos emergencias relacionadas con incendios, rescates y situaciones de riesgo. Nuestro equipo está altamente capacitado y equipado con tecnología avanzada para brindar una respuesta eficiente y segura. Nos aseguramos de actuar con rapidez para proteger la vida de las personas, prevenir daños materiales y minimizar los impactos de los incendios en nuestra comunidad. Además, estamos disponibles para asistir a eventos, ofreciendo seguridad y apoyo ante cualquier eventualidad.
                        </motion.p>
                    </div>
                </div>
                ...
                <div className="bg-gray-100 py-16 px-6">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <motion.p
                            ...
                            transition={{ duration: 1, delay: 0.5 }}
                        >
                            Aunque no contamos con una ambulancia propia, brindamos atención primaria en emergencias médicas mientras llega un servicio especializado. Contamos con Desfibriladores Externos Automáticos (DEAs) y equipo avanzado para asistir en situaciones críticas. Nuestra prioridad es estabilizar a los pacientes y asegurar su bienestar hasta la llegada de los profesionales adecuados. También estamos presentes en eventos, garantizando la atención inmediata ante cualquier emergencia médica.
                        </motion.p>
                    </div>
                </div>
