        ...
        <>
            ...
            <div className="bg-gray-900 text-white">
                <div className="relative w-full min-h-screen flex flex-col justify-center items-center px-6 py-16 space-y-6 bg-gradient-to-r from-gray-800 via-gray-900 to-black">
                    ...
                    >
                        <img 
                            src="https://media0.giphy.com/media/v1.Y2lkPTc5MGI3NjExbXBpcWttZzBncnk3eXNuend0bm1mMHpoeW00dXZ6cW9ld2ExMGtkayZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/QWaZiiX6leKuwnArja/giphy.gif" 
